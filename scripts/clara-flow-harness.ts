...
{
  // walk to email step
  const w = run(seedAskName(), ['Mario', 'Rossi', '6463125847', 'mañana', 'una factura']);
  const atEmail = w.st;
...
lines.push('C. Email opcional');
{
  ...
  const w2 = run(seedAskName(), ['Mario', 'Rossi', '6463125847', 'mañana', 'una factura']);
  ...
  const w4 = run(seedAskName(), ['Mario', 'Rossi', '6463125847', 'mañana', 'una factura']);
  ...
  const w5 = run(seedAskName(), ['Mario', 'Rossi', '6463125847', 'mañana', 'una factura']);
  ...
  const w6 = run(seedAskName(), ['Mario', 'Rossi', '6463125847', 'mañana', 'una factura']);
...
{
  const w = run(seedAskName(), ['Mario', 'Rossi', '6463125847', 'mañana', 'una factura', 'marioto@gmail.com']);
