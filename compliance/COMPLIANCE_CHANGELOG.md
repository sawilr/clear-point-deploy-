...
- **files_modified:** see git log for `fix/master-audit-2026-09-10` (commits 66d1e72, b9b10da, ad4e9b5 + dependency/docs commits).
- **tests:** deterministic battery via `npm test` (26 suites) — results recorded in the owner report; headless regression (crawl, axe, consent, failure modes, viewports) re-run on the built site.
