...
|---|---|---|---|---|---|
| W1 | **2027 MA/Part D landscape + final average premiums** | CMS | mid–late Sept 2026 (per 2026-07-28 fact sheet) | PY2027 | Sept/Oct audit: capture figures → FUTURE rules; prep AEP education content |
...
| W3 | **2027 Part D max deductible + OOP cap (exact figures)** | CMS | in CY2027 Rate Announcement (Apr 2026) — exact figures NOT yet captured (PDF pending read) | 2027-01-01 | Next audit: read 2027-announcement.pdf / September landscape; do NOT assume 2026's $615/$2,100 carry over |
