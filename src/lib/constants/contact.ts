...
//
// The business phone (1-855-720-8555) is currently hardcoded 87 times across 30
...
export const BUSINESS_PHONE_DISPLAY = '1-855-720-8555';
export const BUSINESS_PHONE_TEL = 'tel:+18557208555'; // href value for <a>
export const BUSINESS_PHONE_E164 = '+18557208555';
export const BUSINESS_PHONE_DIGITS = '8557208555';
