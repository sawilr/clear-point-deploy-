...
export const PHRASE_BANK: Record<PhraseKey, { es: string[]; en: string[] }> = {
  provider_first_ask: {
    es: [
      ...
      'Le escucho. Lo que me cuenta es un tema con un doctor/proveedor. Antes de seguir — ¿es doctor primario, o especialista?',
      'Lo tengo. Vamos a ayudarle con eso del doctor/proveedor. Para no perder el hilo — ¿estamos hablando del doctor primario o de un especialista?',
      'Vamos paso a paso. Esto suena a un tema con un doctor/proveedor. Para guiarle bien, ¿es su doctor primario o un especialista?',
    ],
    en: [
      ...
      "I'm with you. What you're describing is a doctor/provider matter. Before we go further — is this your primary doctor, or a specialist?",
      "Noted. Let's help with that doctor/provider topic. To keep clear — are we talking about your primary doctor, or a specialist?",
      "Step by step. That sounds like a doctor/provider issue. To guide you well, is this your primary doctor or a specialist?",
    ],
  },
  provider_repeat_short_ack: {
    es: [
      ...
      'Lo tengo claro. Para avanzar — ¿estamos con su doctor primario, o con un especialista?',
      'Sí, ya entendí. Mejor no repetir: ¿es doctor primario o especialista?',
      'Vale, esa parte ya la tengo. Solo me falta saber: ¿primario o especialista?',
    ],
    en: [
      ...
      "I have that clear. To move forward — are we on your primary doctor, or a specialist?",
      "Yes, understood. Rather than repeat: primary doctor or specialist?",
      "OK, that part I have. I just need to know: primary or specialist?",
    ],
  },
  provider_primary_followup: {
    es: [
  ...
  medication_first_ask: {
    es: [
      ...
      'Le escucho. Para guiarle bien — ¿es por el costo de la medicina, porque el plan no la cubre, o porque la farmacia no la pudo dar?',
      'Lo tengo. Vamos a verlo paso a paso: ¿el tema es el costo, la cobertura, o la farmacia?',
      'Sí, entiendo. Para no asumir — ¿fue precio, fue cobertura, o fue algo en la farmacia?',
    ],
    en: [
      ...
      "I hear you. To guide you well — is it about the cost of the medication, that the plan won't cover it, or the pharmacy couldn't fill it?",
      "Got it. Let's walk through it: is the topic cost, coverage, or the pharmacy?",
      "Yes, I understand. So I don't assume — was it price, coverage, or something at the pharmacy?",
    ],
  },
  medication_pharmacy_reason_ask: {
    es: [
  ...
  recovery_case_a_tier1: {
    es: [
      ...
      'Le entiendo. Para hacerlo bien, ¿de qué se trata — medicamentos, doctor, carta, factura, o beneficios?',
      'Sé que esto cansa. Para apoyarle, ¿cuál es el tema principal — medicamentos, doctor, carta, factura, o beneficios?',
      'Vamos sin prisa. Para ayudarle, dígame el tema: medicamentos, doctor, carta, factura, o beneficios.',
    ],
    en: [
      ...
      "I get it. To do this right, what is it about — medications, doctor, letter, bill, or benefits?",
      "I know this is wearing. To support you, what's the main topic — medications, doctor, letter, bill, or benefits?",
      "No rush. To help, tell me the topic: medications, doctor, letter, bill, or benefits.",
    ],
  },
  recovery_case_a_tier2: {
    es: [
