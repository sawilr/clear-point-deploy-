...
export const INTENTS: IntentDefinition[] = [
  ...
  },
  {
    ...
    keywords_es: ['cita', 'agendar', 'reunion', 'reservar'],
    phrases_en: ['schedule appointment', 'book an appointment', 'set up a meeting', 'schedule a review', 'i need an appointment'],
    phrases_es: ['agendar cita', 'reservar una cita', 'programar una reunion', 'agendar una revision', 'necesito una cita'],
    escalate_to_agent: true,
    require_privacy_warning: false,
    default_urgency: 'normal',
  ...
  {
    id: 'call_requested',
    keywords_en: ['call', 'phone', 'callback', 'speak'],
    keywords_es: ['llamar', 'telefono', 'llamada', 'hablar'],
    phrases_en: ['call me', 'phone call', 'speak with someone', 'i need a call', 'someone to call me', 'talk to a person'],
    phrases_es: ['llamame', 'llamada telefonica', 'hablar con alguien', 'necesito una llamada', 'alguien me llame', 'hablar con una persona'],
    escalate_to_agent: true,
    require_privacy_warning: false,
    default_urgency: 'normal',
  ...
  },
  {
    ...
    keywords_en: ['confused', 'dont understand', 'lost', 'help', 'unclear'],
    keywords_es: ['confundido', 'no entiendo', 'perdido', 'ayuda', 'confuso'],
    phrases_en: ['i dont understand', 'im confused', 'im lost', 'i need help', 'this is confusing', 'i dont know what to do'],
    phrases_es: ['no entiendo', 'estoy confundido', 'estoy perdida', 'estoy perdido', 'necesito ayuda', 'esto es confuso', 'no se que hacer'],
    escalate_to_agent: true,
    require_privacy_warning: true,
    default_urgency: 'high',
