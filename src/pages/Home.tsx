...
const carriers: Carrier[] = [
  ...
  { name: 'Cigna Healthcare',              logo: '/carriers/cigna.png',            alt: 'Cigna Healthcare logo',             logoClass: 'scale-[1.30]' },
  { name: 'Clover Health',                 logo: '/carriers/clover.png',           alt: 'Clover Health logo',                logoClass: 'scale-[1.20]' },
  { name: 'EmblemHealth',                  logo: '/carriers/emblemhealth.png',     alt: 'EmblemHealth logo',                 logoClass: 'scale-[1.20]' },
  { name: 'Empire BlueCross BlueShield',   logo: '/carriers/empire.png',           alt: 'Empire BlueCross BlueShield logo'   },
  { name: 'Fidelis Care',                  logo: '/carriers/fidelis.png',          alt: 'Fidelis Care logo',                 logoClass: 'scale-[1.30]' },
  ...
  { name: 'Wellcare',                      logo: '/carriers/wellcare.png',         alt: 'Wellcare logo',                     logoClass: 'scale-[1.20]' },
