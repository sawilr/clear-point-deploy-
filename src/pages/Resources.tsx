...
const resources = [
  ...
  {
    title: 'Part D and Its Three Stages',
    titleEs: 'Parte D y sus tres etapas',
    desc: 'Learn how prescription drug coverage works: formularies, preferred pharmacies, and the three coverage stages (the "donut hole" gap was eliminated in 2025).',
    descEs: 'Aprenda cómo funciona la cobertura de medicamentos: formularios, farmacias preferidas y las tres etapas de cobertura (la brecha "donut hole" se eliminó en 2025).',
    tag: 'PART D',
    tagEs: 'PARTE D',
  },
  {
...
const guideContent = [
  ...
  },
  {
    en: [
      ...
      '• Mail order options.',
      '',
      'Since 2025 there is no coverage gap ("donut hole"). Drug coverage has three stages: a deductible (if your plan has one), initial coverage, and catastrophic coverage once your out-of-pocket drug costs reach the yearly cap ($2,100 in 2026). Rules may change by year and plan.',
    ...
    es: [
      ...
      '',
      'Desde 2025 ya no existe la brecha de cobertura ("donut hole"). La cobertura de medicamentos tiene tres etapas: un deducible (si su plan lo tiene), la cobertura inicial y la cobertura catastrófica cuando sus gastos de bolsillo en medicamentos llegan al tope anual ($2,100 en 2026). Las reglas pueden cambiar por año y por plan.',
