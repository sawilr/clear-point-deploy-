      ...
      <div ref={reveal.ref} className={`max-w-3xl mx-auto px-5 transition-all duration-700 ${reveal.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
        ...
        <div className="space-y-8 text-earth-700 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>
              {t(
                'We do not sell your personal information. We may share your information with: (a) insurance carriers when you choose to enroll in a plan; (b) service providers who assist us in operating our website and delivering services — this includes our customer relationship system (GoHighLevel), our website host (Vercel), and the artificial-intelligence providers that generate the replies of our online assistants Clara and Zara and summarize lead notes for our advisors (currently OpenAI and Anthropic; your chat messages are screened for Social Security, Medicare and account numbers before they are sent, and these providers are not permitted to use your information to train their models); (c) legal or regulatory authorities when required by law. Calls with our phone assistants (Emely and Sofía) and with our advisors may be recorded for quality and compliance purposes, and you will be told at the start of the call. All third parties are contractually bound to protect your information.',
                'No vendemos su información personal. Podemos compartir su información con: (a) aseguradoras cuando elige inscribirse en un plan; (b) proveedores de servicios que nos ayudan a operar nuestro sitio web y brindar servicios — esto incluye nuestro sistema de gestión de clientes (GoHighLevel), el alojamiento del sitio (Vercel) y los proveedores de inteligencia artificial que generan las respuestas de nuestras asistentes en línea Clara y Zara y resumen las notas para nuestros asesores (actualmente OpenAI y Anthropic; sus mensajes de chat se revisan para eliminar números de Seguro Social, de Medicare y de cuentas antes de enviarse, y estos proveedores no pueden usar su información para entrenar sus modelos); (c) autoridades legales o regulatorias cuando lo requiera la ley. Las llamadas con nuestras asistentes telefónicas (Emely y Sofía) y con nuestros asesores pueden grabarse con fines de calidad y cumplimiento, y se le informará al inicio de la llamada. Todos los terceros están contractualmente obligados a proteger su información.'
              )}
            </p>
          </section>
