      ...
      <div className="relative">
        ...
        <form onSubmit={handleSubmit} method="post" action="#" className="space-y-3.5" noValidate aria-labelledby="lead-form-heading">
          ...
          <div className="bg-cream-100 rounded-lg p-4 border border-cream-300">
            ...
            {/* AUDIT 2026-09-13 (FTC-02/FTC-03, P1) — the material connection has
                to sit inside the conversion path, not below the fold: the page
                claims "free" several times before the visitor reaches this point. */}
            <p className="text-sm text-earth-700 mt-2">
