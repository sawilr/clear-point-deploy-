  ...
  async function defaultEscalate(s: ConversationState, msgs: Message[]) {
    ...
    try {
      ...
      const payload = {
        ...
        form_name: 'ClearPoint Support Guide (V15)',
        first_name: s.name || '',
        last_name: '',
        full_name: s.name || '',
        phone: '',
        ...
        bot_transcript_summary: `V15 · ${s.language} · ${s.intent} · ${s.emotionalState}`,
        tags: [
